...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Stock.item_name'
        db.add_column('stocks_stock', 'item_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Stock.size'
        db.add_column('stocks_stock', 'size', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Stock.item_name'
        db.delete_column('stocks_stock', 'item_name')

        # Deleting field 'Stock.size'
        db.delete_column('stocks_stock', 'size')
