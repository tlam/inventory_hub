...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ImportEntry.foreign_supplier'
        db.delete_column('entries_importentry', 'foreign_supplier_id')
    ...
    models = {
        'entries.importentry': {
            ...
            'foreign_supplier': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['suppliers.ForeignSupplier']"}),
