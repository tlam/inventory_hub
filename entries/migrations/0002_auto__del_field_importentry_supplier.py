...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ImportEntry.supplier'
        db.delete_column('entries_importentry', 'supplier_id')


    def backwards(self, orm):
        
        # Adding field 'ImportEntry.supplier'
        db.add_column('entries_importentry', 'supplier', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['suppliers.Supplier']), keep_default=False)
