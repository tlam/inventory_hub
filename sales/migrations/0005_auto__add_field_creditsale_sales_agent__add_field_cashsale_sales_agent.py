...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CreditSale.sales_agent'
        db.add_column('sales_creditsale', 'sales_agent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staffs.SalesAgent'], null=True, blank=True), keep_default=False)

        # Adding field 'CashSale.sales_agent'
        db.add_column('sales_cashsale', 'sales_agent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staffs.SalesAgent'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CreditSale.sales_agent'
        db.delete_column('sales_creditsale', 'sales_agent_id')

        # Deleting field 'CashSale.sales_agent'
        db.delete_column('sales_cashsale', 'sales_agent_id')
    ...
    models = {
        ...
        'customers.customer': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 3, 11, 37, 22, 370912)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 3, 11, 37, 22, 370912)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'sales.cashsale': {
            ...
            'contact_list': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contacts.ContactList']", 'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 3, 11, 37, 22, 373675)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 3, 11, 37, 22, 373715)', 'auto_now': 'True', 'blank': 'True'}),
