...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CreditSale.cart'
        db.add_column('sales_creditsale', 'cart', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stock_carts.StockCart'], null=True, blank=True), keep_default=False)

        # Adding field 'CashSale.cart'
        db.add_column('sales_cashsale', 'cart', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stock_carts.StockCart'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CreditSale.cart'
        db.delete_column('sales_creditsale', 'cart_id')

        # Deleting field 'CashSale.cart'
        db.delete_column('sales_cashsale', 'cart_id')
    ...
    models = {
        'customers.customer': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 17, 9, 43, 10, 347010)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 17, 9, 43, 10, 347010)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'sales.cashsale': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 17, 9, 43, 10, 351227)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 17, 9, 43, 10, 351270)', 'auto_now': 'True', 'blank': 'True'}),
