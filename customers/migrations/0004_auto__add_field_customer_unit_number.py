...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Customer.unit_number'
        db.add_column('customers_customer', 'unit_number', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Customer.unit_number'
        db.delete_column('customers_customer', 'unit_number')
    ...
    models = {
        'customers.customer': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 25, 11, 7, 11, 129423)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'unit_number': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 25, 11, 7, 11, 129471)', 'auto_now': 'True', 'blank': 'True'}),
