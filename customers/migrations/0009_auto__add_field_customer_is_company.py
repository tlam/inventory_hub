...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Customer.is_company'
        db.add_column('customers_customer', 'is_company', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Customer.is_company'
        db.delete_column('customers_customer', 'is_company')
    ...
    models = {
        ...
        'customers.customer': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 29, 15, 42, 38, 4587)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 29, 15, 42, 38, 4587)', 'auto_now': 'True', 'blank': 'True'}),
