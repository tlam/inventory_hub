...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Quotation.cart'
        db.add_column('quotations_quotation', 'cart', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stock_carts.StockCart'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Quotation.cart'
        db.delete_column('quotations_quotation', 'cart_id')
    ...
    models = {
        'customers.customer': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 16, 20, 44, 45, 469784)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 16, 20, 44, 45, 469784)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'quotations.quotation': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 16, 20, 44, 45, 472050)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 16, 20, 44, 45, 472091)', 'auto_now': 'True', 'blank': 'True'}),
