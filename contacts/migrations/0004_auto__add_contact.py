...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('contacts_contact', (
            ...
            ('contact_list', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contacts', to=orm['contacts.ContactList'])),
        ))
    ...
    models = {
        ...
        'customers.customer': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 14, 10, 45, 37, 813500)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 14, 10, 45, 37, 813500)', 'auto_now': 'True', 'blank': 'True'}),
